...
interface ClanMatchUserRepository: JpaRepository<MatchUser, Long> {
    ...
    fun findMatchUserList(@Param(value = "matchId") matchId: Long, @Param(value = "clanId") clanId: String): List<MatchUser>

    fun findByClanMatchAndUser(clanMatch: ClanMatch, user: User): MatchUser
}
